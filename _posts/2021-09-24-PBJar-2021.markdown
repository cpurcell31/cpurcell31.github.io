...
**Figure 17-2** shows the decoding in action. Eventually, the audio ends and the full
picture is rendered.

![Moon Landing](/assets/pbjar/luna3.png)
<figcaption align=center><b>Figure 17-3: Resulting SSTV Image - Man on the Moon</b></figcaption>
&nbsp;
